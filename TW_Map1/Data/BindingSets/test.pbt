Assets {
  ...
  BindingSetAsset {
    ...
    Bindings {
      ...
      CoreBehavior {
        Value: "mc:ecorebehavior:mountmenu"
      }
    }
    Bindings {
      BindingType {
      ...
      CoreBehavior {
        Value: "mc:ecorebehavior:emotemenu"
      }
    }
    Bindings {
      BindingType {
      ...
      CoreBehavior {
        Value: "mc:ecorebehavior:charactermenu"
      }
    }
    Bindings {
      BindingType {
    ...
    Bindings {
      ...
      AxisBindingData {
        IncreaseInputs {
          ...
          Controller {
            Value: "mc:ebindinggamepad:rightshoulder"
          }
        }
        DecreaseInputs {
          KeyboardPrimary {
          ...
          Controller {
            Value: "mc:ebindinggamepad:leftshoulder"
          }
        }
      }
      CoreBehavior {
