...
function StateSTART(manager, propertyName)
	...
	if mainGameStateManager:GetCustomProperty("GameState") ~= "MODE_STATE" then
	...
	voteListener = Events.ConnectForPlayer("MODE_VOTE", SetVote)
...
function StateEND()
	...
	Events.Broadcast("CHANGE_STATE", "MODE_STATE")
